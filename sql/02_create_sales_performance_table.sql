...
-- Create sales performance table with full path
CREATE OR REPLACE TABLE hackathon.hackathon_spiffit.sales_performance (
...
-- Insert sample data
INSERT INTO hackathon.hackathon_spiffit.sales_performance VALUES
